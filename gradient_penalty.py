"""From https://github.com/Yunyung/Characteristic-preserving-Latent-Space-for-Unpaired-Cross-domain-Translation-of-3D-Point-Clouds"""
import torch
...
class GradientPenalty:
    ...
    def __init__(self, lambdaGP, gamma=1, vertex_num=2500, device=torch.device('cuda')):
